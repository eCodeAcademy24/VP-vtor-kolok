package mk.ecode.employees;

import com.fasterxml.jackson.core.JsonProcessingException;
import mk.ecode.employees.util.CodeExtractor;
import mk.ecode.employees.util.ExamAssert;
import mk.ecode.employees.util.SubmissionHelper;
...
import mk.ecode.employees.selenium.AbstractPage;
import mk.ecode.employees.selenium.AddOrEditForm;
import mk.ecode.employees.selenium.ItemsPage;
import mk.ecode.employees.selenium.LoginPage;
...
public class SeleniumScenarioTest {
    ...
    private static String admin = "employee.1@ecode.mk";
    private static String adminPassword = "emp1";
    private static String user = "employee.2@ecode.mk";
