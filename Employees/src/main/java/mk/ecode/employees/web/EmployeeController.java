package mk.ecode.employees.web;
...
public class EmployeeController {
    ...
    public String create(@RequestParam String name,
        ...
        service.create(name, email, password, type, skillId, employmentDate);
    ...
    public String update(@PathVariable Long id,
                         ...
                         @RequestParam List<Long> skillId,
                         @RequestParam LocalDate employmentDate) {
        service.update(id, name, email, password, type, skillId, employmentDate);
        return "redirect:/employees";
    }
