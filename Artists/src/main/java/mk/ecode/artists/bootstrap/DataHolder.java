...
public class DataHolder {
    ...
    @PostConstruct
    public void init() {
        Album album1 = new Album("Album 1", "Genre 1", 2001);
        Album album2 = new Album("Album 2", "Genre 2", 2000);
        Album album3 = new Album("Album 3", "Genre 3", 2003);
        Album album4 = new Album("Album 4", "Genre 4", 2005);
        Album album5 = new Album("Album 5", "Genre 5", 2006);
        albums.add(album1);
        albums.add(album2);
        albums.add(album3);
        albums.add(album4);
        ...
        songs.add(new Song("6", "Song 6", "Pop", 2007, album1));
        songs.add(new Song("7", "Song 7", "Jazz", 2008, album2));
        songs.add(new Song("8", "Song 8", "Rap", 2009, album3));
        songs.add(new Song("9", "Song 9", "Pop", 2010, album4));
        songs.add(new Song("10", "Song 10", "Hip-Hop", 2001, album5));
    }
}
