...
public class PlayersController {
    ...
    public String showPlayers(@RequestParam(required = false) Double pointsPerGame,
        ...
        if (pointsPerGame != null || position != null) {
            players = playerService.listPlayersWithPointsLessThanAndPosition(pointsPerGame, position);
        } else {
            players = playerService.listAllPlayers();
        }
    ...
    public String create(@RequestParam String name,
        ...
        playerService.create(name, bio, pointsPerGame, position, team);
    ...
    public String update(@PathVariable Long id,
                         ...
                         @RequestParam PlayerPosition position,
                         @RequestParam Long team) {
        playerService.update(id, name, bio, pointsPerGame, position, team);
        return "redirect:/players";
    }
